...
CONFIG.TextEditor.enrichers.push(
    {
        ...
        enricher: async (match, options) => {
            ...
            const myData = `<a class="control myscene" data-scene-id="${id}" data-tooltip="Activate scene" aria-describedby="tooltip"><b>${scene?.name}</b></a>`;
            doc.innerHTML = myData;
            return doc;
        }
    });

    $(document).on("click", ".myscene", activateScene);
});
